...
return view.extend({
	...
	render: function (basic) {
		...
		o.value('127.0.0.1:7874', _('OpenClash'));
		o.value('127.0.0.1:1053', _('Mihomo'));
		...
		o.value('https://raw.githubusercontent.com/TG-Twilight/AWAvenue-Ads-Rule/main/Filters/AWAvenue-Ads-Rule-Mosdns_v5.txt', 'AWAvenue-Ads-Rule')
