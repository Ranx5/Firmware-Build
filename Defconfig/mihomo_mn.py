...
if os.path.exists('/etc/nikki/profiles/config_mn.yaml'):
    os.system('rm /etc/nikki/profiles/config_mn.yaml')
    print('删除旧配置！')
with open('/etc/nikki/profiles/config_mn.yaml', 'w') as file:
