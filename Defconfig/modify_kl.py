...
Strategy0 = ['Proxy', 'YouTube']
Strategy1 = ['Google', 'DisneyPlus', 'Netflix', 'OpenAI']
Strategy2 = ['Instagram', 'GitHub', 'Twitter', 'Telegram']
...
if os.path.exists('/etc/openclash/config/config_kl.yaml'):
    os.system('rm /etc/openclash/config/config_kl.yaml')
    print('删除旧配置！')
with open('/etc/openclash/config/config_kl.yaml', 'w') as file:
