...
HK = data["proxies"].select { |n| n["name"].include?("HK")}.select { |n| n["name"].include?("三网")}.map { |n| n["name"] }
TW = data["proxies"].select { |n| n["name"].include?("TW")}.select { |n| n["name"].include?("三网")}.map { |n| n["name"] }
JP = data["proxies"].select { |n| n["name"].include?("JP")}.select { |n| n["name"].include?("三网")}.map { |n| n["name"] }
SG = data["proxies"].select { |n| n["name"].include?("SG")}.select { |n| n["name"].include?("三网")}.map { |n| n["name"] }
US = data["proxies"].select { |n| n["name"].include?("US")}.select { |n| n["name"].include?("三网")}.map { |n| n["name"] }
