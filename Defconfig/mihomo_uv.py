...
if os.path.exists('/etc/nikki/profiles/config_uv.yaml'):
    os.system('rm /etc/nikki/profiles/config_uv.yaml')
    print('删除旧配置！')
with open('/etc/nikki/profiles/config_uv.yaml', 'w') as file:
