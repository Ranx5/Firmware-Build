...
mv "$TEMP_DIR"/packages_ci/v2dat*.* "$TEMP_DIR"/packages_ci/v2dat.ipk
mv "$TEMP_DIR"/packages_ci/v2ray-geoip*.* "$TEMP_DIR"/packages_ci/v2ray-geoip.ipk
mv "$TEMP_DIR"/packages_ci/v2ray-geosite*.* "$TEMP_DIR"/packages_ci/v2ray-geosite.ipk
mv "$TEMP_DIR"/packages_ci/mosdns*.* "$TEMP_DIR"/packages_ci/mosdns.ipk
mv "$TEMP_DIR"/packages_ci/luci-app-mosdns*.* "$TEMP_DIR"/packages_ci/luci-app-mosdns.ipk
mv "$TEMP_DIR"/packages_ci/luci-i18n-mosdns-zh-cn*.* "$TEMP_DIR"/packages_ci/luci-i18n-mosdns-zh-cn.ipk
