...
CONFIG_MODIFY_URL="https://raw.githubusercontent.com/Ranx5/Firmware-Build/main/Defconfig/modify_kl.py"
NIKKI_MODIFY_URL="https://raw.githubusercontent.com/Ranx5/Firmware-Build/main/Defconfig/mihomo_kl.rb"
...
wget -qO- $CONFIG_MODIFY_URL > files/etc/openclash/modify_kl.py
wget -qO- $NIKKI_MODIFY_URL > files/etc/nikki/mihomo_kl.rb
...
chmod +x files/etc/openclash/modify_kl.py
chmod +x files/etc/nikki/mihomo_kl.rb
